...
<body>
	...
	<div class="page">
		...
		<div class="left-content">
			<div class="menu-left">
				<ul>
					...
					<li><a href="DairyProduct.jsp" title="Dairy products"
						class="active"><img src="images/icon/icons8-cheese-48.png" />
							Dairy products</a></li>
		...
		<div class="center-content">
			...
			<div class="flex-x">
				<%
					for( DairyProduct d:dp){
					if(d.getId()>0){
				%>
				<div class="flex-1">
					<a href="productDairyProductDetails.jsp?id=<%=d.getId()%>"><img
						src="<%=d.getPictureName()%>" title="<%=d.getType()%>">
						<br><%=d.getType()%><br><%=d.getPrice()%> lv. </a>
				</div>
				<%
					}
				}
