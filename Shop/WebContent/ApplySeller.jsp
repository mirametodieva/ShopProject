			...
			<form class="contact">
				...
				<fieldset>
					...
					<br> <label for="grow">How far do you want to grow
						...
						value="shopAssistant"> <label for="shopAssistant">shop-assistant</label>
					<input type="radio" id="managerOrders" name="grow"
						value="managerOrders"> <label for="managerOrders">manager
						orders</label> <input type="radio" id="boss" name="grow" value="boss">
					<label for="boss">boss</label> <input type="radio" id="temporarily"
						name="grow" value="temporarily"> <label for="temporarily">I
